...
class Fighter():
    def __init__(self,n,hp=10):self.n=n;self.hit_points=hp
    def __repr__(self):return self.n+" (HP: "+str(self.hit_points)+")"
    def take_damage(self,dmg):self.hit_points-=dmg;print("\tAlas,",self.n, "has fallen!" ) if self.hit_points<=0 else print("\t"+self.n,"has",self.hit_points,"hit points remaining.")
...
fone,ftwo,cr=Fighter("Leeroy Jenkins"),Fighter("Mitsurugi"),1
